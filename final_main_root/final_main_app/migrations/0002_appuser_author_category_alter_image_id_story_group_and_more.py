# Generated by Django 4.0.6 on 2022-10-21 07:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='category_stories', to='final_main_app.category')),
            ],
            options={
                'ordering': ['-created_on'],
            },
